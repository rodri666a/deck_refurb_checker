...
COUNTRY = os.getenv("COUNTRY", "ES").upper()

# Paquetes/Modelos (Refurb)
PACKAGES = {
...
# Rate-limit entre llamadas (en segundos)
...
# Gmail SMTP (opcional; requiere 2FA + App Password)
...
def check_one(package_id: int, country_code: str) -> bool:
    """Devuelve True si hay stock de ese package en el país indicado."""
    params = {
...
def notify_telegram(text: str):
    """Envía mensaje a Telegram si hay credenciales."""
...
def notify_email(subject: str, body: str):
    """Envía email por Gmail si hay credenciales."""
